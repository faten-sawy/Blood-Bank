...
class Notifications extends Component {
  ...
  componentDidMount() {
    ...
    // If data is a URL
    firebase.database().ref(`Users/${currentUser}`).child('Notification').get().then(res =>{
      if(res.exists()){
        this.setState({ data: Object.values(res.val())})
  ...
  render() {
    ...
    return (
      <div style={{width:'4vw'}} className={classes.notifications} ref={this.containerRef}>
        <div
